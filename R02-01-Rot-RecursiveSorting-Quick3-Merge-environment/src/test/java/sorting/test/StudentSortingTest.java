...
public class StudentSortingTest {
	...
	@Test
	public void testSortInRange05() {
		genericTestInRange(new Integer[] { 3, 5, 7, 2, 7, 8, 1, 3, 1, 11, 11, 11, 0, 7, 1, 1}, 0, 15);
	}

	@Test
	public void testSortInRange06() {
		genericTestInRange(new Integer[] { 2, 3 }, 0, 1);
	}
